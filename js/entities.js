var Entities = {
	...
	helpers: {
		...
		Coin: function(img, x, y, w, h) {
			...
			this.spriteAnimations = {
				spin: {
					frames: [new Entities.helpers.Sprite(img, 99, 0, 10, 14), new Entities.helpers.Sprite(img, 115, 0, 10, 14),
						new Entities.helpers.Sprite(img, 131, 0, 10, 14), new Entities.helpers.Sprite(img, 147, 0, 10, 14)
					],
					currentFrame: 0
				}
			};
